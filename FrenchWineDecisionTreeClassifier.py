...
#%matplotlib inline
# 调入数据
df = pd.read_csv('E:\python3\Scripts\frenchwine.csv')
...
plt.figure(figsize=(20, 10)) #利用seaborn库绘制三种frenchwine不同参数图
...
Chinese_name=[]
for x in model.predict(X_test[0:3]):
	if x=="Zinfandel":
		Chinese_name.append("仙粉黛")
	if x=="Syrah":
		Chinese_name.append("西拉")
	if x=="Sauvignon":
		Chinese_name.append("赤霞珠")
